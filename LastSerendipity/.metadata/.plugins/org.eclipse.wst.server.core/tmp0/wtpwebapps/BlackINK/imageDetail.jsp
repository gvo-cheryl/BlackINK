...
<div class="field">
	...
	<div class="first">
				<div class="text">
					<p>타투이스트 </p>
					<p>Title </p>
					<p style="margin-bottom: 80px;">Content</p>
					<p>Keyword</p>
					<p>Text tag</p>
					<p>등록일</p>
				</div>
	...
	<div class="first">
		<p><a><b>${dto.ts_writer }</b></a></p>
		<p><input type="text" name="ts_title" value="${dto.ts_title }" class="textform" /></p>
		<p><textarea rows="5" name="ts_content" class="textform"  >${dto.ts_content }</textarea></p>
		<p style="width:300px;">
