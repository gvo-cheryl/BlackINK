...
SELECT ME_SNS_TOKEN FROM MEMBER;
UPDATE MEMBER SET ME_ROLE = 'U' WHERE ME_NO = 222;
SELECT ME_NO FROM MEMBER WHERE ME_EMAIL = 'gassina92@gmail.com';
DELETE FROM MEMBER WHERE ME_NO = 265;
DELETE FROM MEMBER WHERE ME_SNS_TOKEN LIKE 'AAAAOsV1r16tV263zRfO8_%';
SELECT ME_NO
	    , ME_NAME
	    , ME_EMAIL
	    , ME_PW
	    ...
	    , ME_SNS_TOKEN
    FROM MEMBER
    	WHERE ME_EMAIL= 'gassina92@gmail.com'
    	AND ME_SNS_TYPE= 'NAVER';
