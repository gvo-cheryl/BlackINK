 ...
 * Generated at: 2020-10-04 20:00:14 UTC
...
public final class noticeInsert_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 response.setContentType("text/html; charset=UTF-8"); 
   ...
   if (role == null) {
      ...
      out.write("      <form action=\"NoticeController.do?command=insertform\" method=\"post\">\r\n");
      out.write("      <!-- multipart/form-data 형식으로 보낸 데이터는 문자열이든 사진이든 상관없이 Stream 방식으로 전송된다. -->\r\n");
      out.write("      <!-- request.getInputStream() 메서드가 반환한 ServletInputStream객체를 통해 데이터를 전달받을 수 있다. -->\r\n");
        ...
        if (_jspx_eval_c_005fchoose_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /noticeInsert.jsp(61,21) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /noticeInsert.jsp(64,21) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("                    <textarea cols=\"130\" rows=\"20\" name=\"content\" style=\"resize:none;\"></textarea>\r\n");
      out.write("                    \r\n");
      out.write("               </div>\r\n");
