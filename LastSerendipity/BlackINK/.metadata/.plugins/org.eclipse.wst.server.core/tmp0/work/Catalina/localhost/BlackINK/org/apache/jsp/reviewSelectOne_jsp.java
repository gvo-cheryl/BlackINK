 ...
 * Generated at: 2020-10-01 15:28:57 UTC
...
public final class reviewSelectOne_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 response.setContentType("text/html; charset=UTF-8"); 
	...
	String regdate = transFormat.format(dtoRegdate);
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t<input type=\"button\" value=\"수정\" onclick=\"location.href='ReviewController.do?command=update&no=");
      out.print(dto.getNo() );
      out.write("'\">\r\n");
      out.write("\t\t\t\t\t<input type=\"button\" value=\"삭제\" onclick=\"location.href='ReviewController.do?command=delete&no=");
      out.print(dto.getNo() );
      out.write("'\">\r\n");
      out.write("\t\t\t\t</p>\r\n");
      out.write("\t\t\t</div>\r\n");
