...
#inquiry{width: 50px; height:50;  position: relative; left: 30%; top:30px;}
#bottom{height:200px;}
</style>
</head>
<body>
    ...
    // 정상적으로 검색이 완료됐으면 
     if (status === kakao.maps.services.Status.OK) {
        ...
        var infowindow = new kakao.maps.InfoWindow({
            content: '<div style="width:150px;text-align:center;padding:6px 0;">'+ $("#pr_adr_main").val() +'</div>'
        });
...
<div>
	...
	<table id="searchList" >
    	...
    	<input type="button" value="문의하기" id="inquiry" />
   </form>
</div>
