...
article{width:70%; height: auto; position: relative; left: 20%;}
...
#searchList td li{text-align: center;}
#writer{color:gray;}
#resultCount{font-size: small; color: gray; font-weight: normal; padding-left: 2%;}
.noresult{position: relative; left:50%; text-align:center; width:500px;}
.label{position: relative; width:90%; left: 4.5%; border: 1px solid gray; padding: 1%; color: gray; margin-top: 3%;}
#bottom{height:5%;}
#textForm p, #textForm p input{display: inline-block;}
</style>
	    					...
	    					<ul id="ajaxReset">
	    						<li>
	    							<a href="profileController.do?command=imageDetail_Ts&im_no=${dto.im_no }&me_no=${dto.me_no}" id="imageClick">
	    								<img src="/BlackINK/img/${dto.im_servername}" id="imageList" alt="">
	    							</a>
	    						</li>
	    						<li>
