...
<style type="text/css">
#total{width:65%; height: 2400px; position: relative; left: 25%; }
body{background: ghostwhite;}
#me_nic, #intro, #map_wrap, #sample, #calender{width: 100%; } 
#me_nic{height: 100px; text-align: center; align-content: center;}
#me_nic h1{position: relative; top: 40%;}
#intro{height: 10%; position: relative;}
#intro #intro_title{position: relative; left:3%; top:3%;}
#intro hr{position: relative; top: 5%; }
#intro p{position: relative; top: 10%; left: 5%;}
#map_wrap{height: 21%; position: relative;}
...
#sample #sample_text{position: relative; top: 40%; left: 5%; color:gray; font-size: small;}
#Schedule{height: 20%; position: relative;}
...
#editSchedule{position: relative; top:20%; right: 5%;}
...
<div id="total">
	...
	<div id="intro">
		...
		<div align="right" id="edit"><input type="button" value="프로필수정" onclick="location.href='profileController.do?command=updateForm&me_no=${dto.me_no}'"/></div>
	</div>
	<div id="map_wrap">
...
geocoder.addressSearch(pr_adr_main, function(result, status) {
	...
	<div id="sample">
		...
		<hr>
		<p id="sample_text">클릭하면 도안의 세부내용을 수정할 수 있습니다.</p>
	...
	<div id="Schedule">
		...
		<hr>
		<div align="center"><%@ include file="./profileCalendar.jsp"%></div>
		<div align="right" id="editSchedule"><input type="button" value="일정수정" onclick="location.href='tCalController.do?command=listcals&me_no=${dto.me_no}'"/></div>
	</div>
