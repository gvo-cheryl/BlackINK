...
<script type="text/javascript">
	...
	function emailck() {
		...
		if (doc.value == null || doc.value.trim() == "") {
			...
			open("emailck.do?command=emailck&me_email=" + doc.value,
					"email중복체크", "width=300px,height=100px");
		}
	}
</script>
</head>
<body>
	...
	<form id="signupForm" action="regist.do" method="post">
		...
		<table class=info>
			<tr>
				<th>구 분</th>
				<td><input type="radio" name="me_role" checked
					onclick="show_form();" value="U" /> <label for="normal">일반회원</label>
			...
			<tr id="me_nic_tr" style="display: none">
				<th>닉네임</th>
				<td><input type="text" name="me_nic"
					style="height: 25px; width: 250px;" id="me_nic" /></td>
			</tr>
			<tr>
				<th>EMAIL</th>
				<td><input type="text" name="me_email"
					style="height: 25px; width: 250px;" title="n" />
					<button type="button" id="idche" onclick="emailck();">중복확인</button>
				</td>
			</tr>
			<tr>
				<th>비밀번호</th>
				<td><input type="password" name="me_pw"
					style="height: 25px; width: 250px;" /></td>
			</tr>
			<tr>
				<th>비밀번호 확인</th>
				<td><input type="password" name="me_pwck"
					style="height: 25px; width: 250px;" /></td>
			</tr>
			<tr>
				<th>휴대전화</th>
				<td><input type="text" name="me_phone1"
					style="height: 25px; width: 50px;" /><span> -</span> <input
					type="text" name="me_phone2" style="height: 25px; width: 50px;" /><span>
						-</span> <input type="text" name="me_phone3"
					style="height: 25px; width: 50px;" /></td>
			</tr>
			<tr>
				<th>생년월일</th>
			...
			<tr>
				<td colspan="3" align="center"><input type="button" value="가입"
					onclick="javascript:fn_signup_check();" /> <input type="button"
					value="취소" onclick="main.jsp" /></td>
			</tr>
